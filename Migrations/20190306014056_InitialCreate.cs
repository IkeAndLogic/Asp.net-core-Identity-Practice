        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Tractors_TractorID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverTractorAssignmentHistoryId = table.Column<int>(nullable: false),
                    DateTimeUnAssigned = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverTractorsAssignmentHistory", x => new { x.ApplicationUserId, x.TractorId, x.DateTimeAssigned });
                    table.ForeignKey(
                        name: "FK_DriverTractorsAssignmentHistory_Tractors_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "Tractors",
                        principalColumn: "TractorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DriverTractorsAssignmentHistory_AspNetUsers_TractorId",
                        column: x => x.TractorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
